//
//  YahooFinanceWithAddWebViewController.swift
//  STCK
//
...
class YahooFinanceWithAddWebViewController: UIViewController {
    ...
    */
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.setRightBarButtonItem(UIBarButtonItem(barButtonSystemItem: .Add, target: self, action: #selector(YahooFinanceWithAddWebViewController.addButtonTapped)), animated: true)
        
        let youTubeURL = "http://finance.yahoo.com/q;_ylt=AnquPBDtHTlN6u2BYjx4cZ0nv7gF?uhb=uhb2&fr=uh3_finance_vert_gs&type=2button&s=\(stockSymbol)"
        /*
    ...
    //Add THIS stock to favorites IF it does not already exist
    func addButtonTapped() {
        
        if (applicationDelegate.watchListSymbols.objectForKey(stockSymbol) == nil) {
            
            applicationDelegate.watchListSymbols.setObject(stockName, forKey: stockSymbol)
